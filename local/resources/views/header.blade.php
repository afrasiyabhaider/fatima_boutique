...
$pages_cnt = DB::table('pages')->orderBy('page_title','asc')->count();
if(!empty($pages_cnt)) {
...
var LHCChatOptions = {};
LHCChatOptions.opt = {widget_height:340,widget_width:300,popup_height:520,popup_width:500,domain:'zombiebazar.com'};
(function() {
var po = document.createElement('script'); po.type = 'text/javascript'; po.async = true;
var referrer = (document.referrer) ? encodeURIComponent(document.referrer.substr(document.referrer.indexOf('://')+1)) : '';
var location  = (document.location) ? encodeURIComponent(window.location.href.substring(window.location.protocol.length)) : '';
po.src = '//chat.zombiebazar.com/index.php/chat/getstatus/(click)/internal/(position)/bottom_right/(ma)/br/(top)/350/(units)/pixels/(leaveamessage)/true?r='+referrer+'&l='+location;
                                ...
                                <ul class="list-unstyled list-inline">
                                    ...
                                    <li class="dropdown dropdown-small"> <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><i class="fa fa-language" aria-hidden="true"></i><span class="value">@lang('languages.english') </span><b class="caret"></b></a>
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="<?php echo $url;?>/<?php echo Lang::get('setlocale/ar');?>">@lang('languages.arabic')</a></li>
                                        </ul>
                                    </li>
