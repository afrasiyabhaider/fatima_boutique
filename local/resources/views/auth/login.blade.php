@extends('layouts.app')@section('content')<?php $url = URL::to("/"); ?><div class="breadcrumb">
     <div class="container">
...
<div class="body-content">
     <div class="container">
          <div class="my-wishlist-page_new">
               ...
               <div class="col-md-6">
                    <div class=""> @if(Session::has('success')) <div class="alert alert-success">
                              {{ Session::get('success') }} </div> @endif @if(Session::has('error')) <div
                    ...
                    <div class="panel panel-default ">
                         ...
                         <div class="panel-body">
                              <form class="register-form" role="form" method="POST" action="{{ route('login') }}">
                                   ...
                                   <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}"> <label
                                             for="email" class="col-md-4">Username / Email</label>
                                        <div class="col-md-8"> <input id="username" type="text"
                                                  class="form-control unicase-form-control" name="username"
                                                  value="{{ old('email') }}" required autofocus> @if
                                             ($errors->has('email')) <span class="help-block">
                                                  <strong>{{ $errors->first('email') }}</strong> </span> @endif </div>
                                   </div>
                                   <div class="height10 clearfix"></div>
                                   <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}"> <label
                                             for="password" class="col-md-4">Password</label>
                                        <div class="col-md-8"> <input id="password" type="password"
                                                  class="form-control unicase-form-control" name="password" required>
                                   ...
                                   <div class="form-group">
                                        <div class="col-md-6 col-md-offset-4">
                                             <div class="checkbox"> <label class="para black"> <input type="checkbox"
                                                            name="remember" {{ old('remember') ? 'checked' : '' }}>
                                                       Remember Me </label> </div>
                                        </div>
                                   </div>
                                   <div class="form-group">
                                        <div class="col-md-8 col-md-offset-4"> <input name="" type="submit"
                                                  value="Login" class="btn-upper btn btn-primary"> <a
                                                  class="btn btn-link para gold" href="{{ route('forgot-password') }}">
                                                  Forgot Your Password? </a> </div>
                                   </div> <?php /*?><div class="form-group">
                                        <div class="col-md-6 col-md-offset-4"> <a href="{{ url('/login/facebook') }}"><i
                                                       class="fa fa-facebook-official" aria-hidden="true"></i>
                                                  Facebook</a> <a href="{{ url('/login/twitter') }}"><i
                                                       class="fa fa-twitter" aria-hidden="true"></i> Twitter</a> <a
...
<div class="height50"></div> @include('footer')@endsection